...
var layersList = [lyr_OSMStandard_0,group_References,group_Superficie_perdue,group_Zonesrisque,group_Prvisiondrosion,group_TauxparTransects,group_Traits_cte_ancien];
...
lyr_qlq_infravulnerableobs_2.set('fieldAliases', {'creator': 'creator', 'version': 'version', 'lat': 'lat', 'lon': 'lon', 'ns1_name': 'ns1_name', 'ns1_ele': 'ns1_ele', 'ns1_time': 'ns1_time', 'photo': 'tof', 'id': 'id', 'path_tof': 'photo', });
...
lyr_infra__500m_TC2054_8.set('fieldAliases', {'id': 'id', 'COMMUNE': 'COMMUNE', 'CANTON': 'CANTON', 'VILLAGE_QU': 'Quartier/village', 'ACTIVITES': 'Activités', 'SECTEUR': 'SECTEUR', 'TYPE': 'TYPE', 'STATUT': 'statut', 'ETAT': 'Etat', 'LONGITUDE': 'LONGITUDE', 'LATITUDE': 'LATITUDE', 'ALTITUDE': 'ALTITUDE', 'field_28': 'field_28', 'field_29': 'field_29', 'Colonne1': 'type', });
...
lyr_TC1990_21.set('fieldAliases', {'Id': 'Id', 'Date_': 'da', 'Uncertaint': 'Uncertaint', });
...
lyr_qlq_infravulnerableobs_2.set('fieldImages', {'creator': 'TextEdit', 'version': 'TextEdit', 'lat': 'TextEdit', 'lon': 'TextEdit', 'ns1_name': 'TextEdit', 'ns1_ele': 'TextEdit', 'ns1_time': 'TextEdit', 'photo': 'ExternalResource', 'id': 'TextEdit', 'path_tof': 'ExternalResource', });
...
lyr_TC1990_21.set('fieldImages', {'Id': 'Hidden', 'Date_': 'DateTime', 'Uncertaint': 'Range', });
...
lyr_qlq_infravulnerableobs_2.set('fieldLabels', {'creator': 'no label', 'version': 'no label', 'lat': 'no label', 'lon': 'no label', 'ns1_name': 'no label', 'ns1_ele': 'no label', 'ns1_time': 'no label', 'photo': 'no label', 'id': 'no label', 'path_tof': 'no label', });
lyr_Zone_dtude_3.set('fieldLabels', {'Noms': 'no label', 'Superficie': 'no label', });
lyr_PaysTOGO_4.set('fieldLabels', {'Superficie': 'no label', });
lyr_2054_5.set('fieldLabels', {'superficie': 'no label', 'type': 'no label', });
lyr_2024_6.set('fieldLabels', {'Superficie': 'no label', 'Typ_': 'no label', });
lyr_1990_7.set('fieldLabels', {'superficie': 'no label', 'type': 'no label', });
lyr_infra__500m_TC2054_8.set('fieldLabels', {'VILLAGE_QU': 'no label', 'ACTIVITES': 'no label', 'ETAT': 'no label', 'Colonne1': 'no label', });
...
lyr_1990_2024LRR_13.set('fieldLabels', {'LRR': 'no label', });
lyr_2001_2014EPR_14.set('fieldLabels', {'EPR': 'no label', 'NSM': 'no label', });
lyr_2014_2024EPR_15.set('fieldLabels', {'EPR': 'no label', 'NSM': 'no label', });
lyr_1990_2001EPR_16.set('fieldLabels', {'EPR': 'no label', 'NSM': 'no label', });
...
lyr_TC1990_21.set('fieldLabels', {'Date_': 'no label', 'Uncertaint': 'no label', });
